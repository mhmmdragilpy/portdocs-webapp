          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="font-bold text-xl tracking-tight text-white">
                Port<span className="text-blue-400">Docs</span>
              </span>
            </Link>
          </div>
            ...
            {user ? (
              <div className="flex items-center gap-3">
                ...
                <form action="/api/auth/signout" method="POST">
                  <button type="submit" className="text-slate-400 hover:text-red-400 p-2 transition-colors">
              ...
              <form action="/api/auth/google" method="POST">
                <button type="submit" className="flex items-center gap-2 bg-white text-slate-900 hover:bg-slate-100 px-4 py-2 rounded-lg text-sm font-bold transition-all shadow-md">
