...
export default function ImageUploader({ label, helperText, onImageProcessed, isPassportPhoto }: ImageUploaderProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 dark:border-slate-700 border-dashed rounded-xl hover:border-blue-400 dark:hover:border-blue-500/50 transition-colors bg-slate-50 dark:bg-slate-800/30">
        <div className="space-y-1 text-center">
          ...
          <div className="flex text-sm text-slate-600 dark:text-slate-400 justify-center">
            <label className="relative cursor-pointer rounded-md font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 focus-within:outline-none">
