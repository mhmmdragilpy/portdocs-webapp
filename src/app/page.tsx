  ...
  return (
    <div className="space-y-12 pb-24">
      ...
      <section className="text-center space-y-6 pt-8 pb-4">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border-blue-500/30 text-blue-300 text-sm font-medium mb-4">
          <Ship className="w-4 h-4" />
          <span>Layanan Cepat & Terpercaya</span>
        </div>
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight">
          Urus Dokumen Pelaut <br className="hidden md:block" />
          <span className="text-gradient">Lebih Mudah & Cepat</span>
        </h1>
        ...
        <div className="glass-card p-6 md:p-8">
          <div className="flex items-center gap-3 mb-8 border-b border-slate-700/50 pb-6">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">Pilih layanan A la Carte dan lengkapi biodata Anda.</p>
            </div>
          </div>
